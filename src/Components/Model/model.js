    ...
    render() {
        return (
            <div className={classes.contain} style={{background: `url(${this.state.contain})`}}>
                ...
                <div className={classes.feetStyle} style={{backgroundImage: `url(${this.props.model.shoes})`, backgroundSize: 'cover'}}></div>
                <div className={classes.handbagStyle} style={{backgroundImage: `url(${this.props.model.handbags})`, backgroundSize: 'cover'}}></div>
                <div className={classes.hairStyle} style={{backgroundImage: `url(${this.props.model.hairstyle})`, backgroundSize: 'cover'}}></div>
                <div className={classes.necklacesStyle} style={{backgroundImage: `url(${this.props.model.necklaces})`, backgroundSize: 'cover'}}></div>
                <div className={classes.backgroundStyle} style={{backgroundImage: `url(${this.props.model.background})`, backgroundSize: 'cover'}}></div>
